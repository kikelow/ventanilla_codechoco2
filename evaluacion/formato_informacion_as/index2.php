      ...
      <div class="row" style="text-align: center;background-color: #bdbdbd;">1.1 Tenencia de la tierra</div>
        <div class="row">
            <div class="input-field col s12 m6 l6">
              <p>
                <input type="checkbox" id="tes1" />
                <label for="tes1">Propietario con escritura</label>
              </p>
            </div>
            <div class="input-field col s12 m6 l6">
        ...
        <div class="row">
            <div class="input-field col s12 m6 l6">
              <p>
                <input type="checkbox" id="tes2" />
                <label for="tes2">Arrendatario</label>
              </p>
            </div>
            <div class="input-field col s12 m6 l6">
              <label for="desc">Descripcion</label>
              <input name="desc2" type="text" id="desc2" />
            </div>
        </div>
        <div class="row">
            <div class="input-field col s12 m6 l6">
              <p>
                <input type="checkbox" id="tes3" />
                <label for="tes3">Posesión tradicional y/o ancestral de tierras y territorios de los pueblos indígenas</label>
              </p>
            </div>
            <div class="input-field col s12 m6 l6">
              <label for="desc">Descripcion</label>
              <input name="desc3" type="text" id="desc3" />
            </div>
        </div>
        <div class="row">
            <div class="input-field col s12 m6 l6">
              <p>
                <input type="checkbox" id="tes4" />
                <label for="tes4">Estatal</label>
              </p>
            </div>
            <div class="input-field col s12 m6 l6">
              <label for="desc">Descripcion</label>
              <input name="desc4" type="text" id="desc4" />
            </div>
        </div>
        <div class="row">
            <div class="input-field col s12 m6 l6">
              <p>
                <input type="checkbox" id="tes5" />
                <label for="tes5">Concesión</label>
              </p>
            </div>
            <div class="input-field col s12 m6 l6">
              <label for="desc">Descripcion</label>
              <input name="desc5" type="text" id="desc5" />
            </div>
        </div>
        <div class="row">
            <div class="input-field col s12 m6 l6">
              <p>
                <input type="checkbox" id="tes6" />
                <label for="tes6">Autorización del propietario o administrador del área</label>
              </p>
            </div>
            <div class="input-field col s12 m6 l6">
              <label for="desc">Descripcion</label>
              <input name="desc6" type="text" id="desc6" />
            </div>
        </div>
