...
<?php 
	...
	$persona_id = $_SESSION["vev_verificador"];
...
$('#form_personales').submit(function(event) {
	...
	$.ajax({
		url: 'evaluacion/informacion_personal/modificar_personal.php',
		type: 'POST',
...
$('#form_contraseña').submit(function(event) {
	...
	if ($('#nueva_contra').val() != $('#conf_contra').val()) {
		...
		$.ajax({
		url: 'evaluacion/informacion_personal/modificar_contrasena.php',
		type: 'POST',
