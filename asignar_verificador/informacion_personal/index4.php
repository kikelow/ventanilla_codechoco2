...
<?php 
	...
	$persona_id = $_SESSION["vev_admin_verificador"];
...
<div class="row" style="">
    ...
    <form class="col s12" id="form_personales">
     <div class="row">
  <div class="col s12 m12 l12"><h4 class="diagonal" style="text-align: center;"> personales</h4> <div class="divider" style=" background-color:  #00853b;"></div></div>
</div>
      <div class="row">
...
$('#form_personales').submit(function(event) {
	...
	$.ajax({
		url: 'asignar_verificador/informacion_personal/modificar_personal.php',
		type: 'POST',
...
$('#form_contraseña').submit(function(event) {
	...
	if ($('#nueva_contra').val() != $('#conf_contra').val()) {
		...
		$.ajax({
		url: 'asignar_verificador/informacion_personal/modificar_contrasena.php',
		type: 'POST',
